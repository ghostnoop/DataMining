...
from UserVk import UserVkClass
from contstants import login, password, vk_user_id
...
def friends_get():
    friends = api.friends.get(user_id=vk_user_id)  # поменять на тот который нужен айди где vk_user_id == 507314859
    print(friends)
    return friends
